package com.baidu.shunba.core.persistence.base;
...
public class MySimpleJdbcTemplate {
...
//		jdbcTemplate = new MySimpleJdbcTemplate(dataSource);
//	}
	...
	*/
	...
	protected <T> RowMapper<T> resultBeanMapper(Class clazz) {

...
public class PwdCheckUtil {
	...
	public static String[] KEYBOARD_SLOPE_ARR = { "!qaz", "1qaz", "@wsx", "2wsx", "#edc", "3edc", "$rfv", "4rfv",
			"%tgb", "5tgb", "^yhn", "6yhn", "&ujm", "7ujm", "*ik,", "8ik,", "(ol.", "9ol.", ")p;/", "0p;/", "+[;.",
			"=[;.", "_pl,", "-pl,", ")okm", "0okm", "(ijn", "9ijn", "*uhb", "8uhb", "&ygv", "7ygv", "^tfc", "6tfc",
			"%rdx", "5rdx", "$esz", "4esz" };
	public static String[] KEYBOARD_HORIZONTAL_ARR = { "01234567890-=", "!@#$%^&*()_+", "qwertyuiop[]", "QWERTYUIOP{}",
	...
	/**
	 * 
	 * @Title: checkKeyboardSlantSite @Description: 物理键盘，斜向连接校验， 如1qaz,4rfv,
	 * !qaz,@WDC,zaq1 返回true @param password 字符串 @param repetitions 重复次数 @param
	 * isLower 是否区分大小写 true:区分大小写， false:不区分大小写 @return boolean 如1qaz,4rfv,
	 * !qaz,@WDC,zaq1 返回true @throws
	 */
	...
	/**
	 * @Title: checkSequentialChars @Description: 评估a-z,z-a这样的连续字符, @param password
	 * 字符串 @param repetitions 连续个数 @param isLower 是否区分大小写 true:区分大小写，
	 * false:不区分大小写 @return boolean 含有a-z,z-a连续字符串 返回true @throws
	 */
	...
	/**
	 * 
	 * @Title: checkSequentialSameChars @Description: 验证键盘上是否存在多个连续重复的字符， 如！！！！,
	 * qqqq, 1111, ====, AAAA返回true @param password 字符串 @param repetitions
	 * 重复次数 @return 参数 @return boolean 返回类型 @throws
	 */
